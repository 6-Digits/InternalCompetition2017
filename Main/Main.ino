#include <Servo.h>
//Pin
//PWM 11, 10 Right and left Servos Respectively; 8, 7, 6, 5 M2F, M2R, M1R, M1F Respectively;
//Digital 46 LED
//Analog A3 Infared; A0 A1 Color Sensors
...
double distanceOne = 100, distanceTwo = 100;
